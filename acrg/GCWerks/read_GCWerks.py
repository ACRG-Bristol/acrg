...
class read_gcexport_crds_flexi(object):
...
class read_gcexport_crds_old(object):
...
# More flexible approach using the headers in the file
class read_gcexport_lgr(object):
...
# More flexible approach using the headers in the file
class read_gcexport_medusa(object):
    def __init__(self, datafile):
...
# More flexible approach using the headers in the file
class read_gcexport_means_flexi(object):
