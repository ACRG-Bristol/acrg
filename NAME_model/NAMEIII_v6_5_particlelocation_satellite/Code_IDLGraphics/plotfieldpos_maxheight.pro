pro plotfieldpos_maxheight,lont,latt,plotdata, $
...
if (polar ne 0) then begin
  map_grid,color=15,/label,/nogrid,charsize=0.6*lcharsize
endif else begin
  latlab=xmin+(xmax-xmin)/20.0
  lonlab=ymin+(ymax-ymin)/20.0
  map_grid,/nogrid,/label,color=15,latlab=latlab,lonlab=lonlab,charsize=0.6*lcharsize
endelse
