pro overplotfield,datadir,selgrid,selspecies=selspecies,$
    ...
    contourcolors=contourcolors,printtimeaverage=printtimeaverage,$
    imagedir=imagedir,imagetemplate=imagetemplate
  ...
  ;                   : in output file
  ;  imagedir         : directory containing images to be overplotted
  ;  imagetemplate    : string containing distinguishing part of image filenames
  ...
  if(n_elements(imagedir) eq 0) then imagedir=datadir
  if(n_elements(imagetemplate) eq 0) then imagetemplate='.gif'
  ...
  imagefiles=findfile(imagedir+delim+'*'+imagetemplate+'*')
      ...
      for ifield=0,numfields-1 do begin
        ...
        for ispec=0,numspecies-1 do begin
          ...
          for it=0,numfiles-1 do begin
            ...
            overplotfieldpos,lon1,lat1,dat1, position=position,type=type,$
