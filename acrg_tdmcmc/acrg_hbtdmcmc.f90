...
REAL sigma_y_new(nmeasure)
 ...
 !do yi=1,dim2
    ...
    !call calc_pdf(sigma_model_current(yi), sigma_model_ap(yi), sigma_model_hyperparam(yi), sigma_model_pdf, p0_sigma_y)
    !call calc_pdf(sigma_model_new, sigma_model_ap(yi), sigma_model_hyperparam(yi), sigma_model_pdf, p1_sigma_y)
